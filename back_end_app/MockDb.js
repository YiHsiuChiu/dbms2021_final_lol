...
const player1 = new Player("superstar999", "star", new Date(1995, 11, 17), "mid", "the8", new Date(2020, 1, 1),"8", "TestImage");
const player2 = new Player("funnyJohn", "john", new Date(2000, 1, 20), "top", "the8", new Date(2021, 12, 20),"3", "TestImage");
let players = [player1, player2];
const team1 = new Team("the8", "Chicago", "Smith", new Date(2011, 3, 29), "North America", "TestImage");
const team2 = new Team("newTeam", "San Diego", "Company", new Date(2020, 5, 23), "North America", "TestImage");
let teams = [team1, team2];
const game1 = new Game(new Date(2021, 3, 10, 13, 0, 0, 0), new Date(2021, 3, 10, 13, 40, 0, 0), "semifinal", 1, "the8", "the8","CN","EU", "newTean", "funnyjohn", 800, 400);
const game2 = new Game(new Date(2021, 3, 10, 14, 0, 0, 0), "null", "semifinal", 2, "null", "the8", "newTean","EU","NA", "null", 300, 300);
